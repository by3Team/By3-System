...
public class AuditLogsController : ControllerBase
{
        ...
        DateTime? endTime = null)
    {
        ...
        return Ok(ApiResult<PageResult<AuditLogListDto>>.Ok(result));
    }
    ...
    public async Task<IActionResult> GetDetail(Guid id)
    {
        ...
        if (result == null)
            return NotFound(ApiResult<object>.Error("日志不存在", 404));
        return Ok(ApiResult<AuditLogDetailDto>.Ok(result));
    }
}
